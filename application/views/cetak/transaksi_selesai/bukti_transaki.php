...
<body style="padding: 10px;" <?= $bo ?>>
	...
	<a href="<?= base_url('C_cetak/cetak_transaksi_selesai/html/' . $id) ?>" class="btn btn-default hidden-print"><span class="glyphicon glyphicon-print"></span> Cetak </a>

	<a href="<?= base_url('C_cetak/cetak_transaksi_selesai/pdf/' . $id) ?>" class="btn btn-danger hidden-print"><span class="glyphicon glyphicon-file"></span> PDF </a>

	<hr class="hidden-print" />

	<?php
	//echo $idtblpembeli->row()->email;
	$email = '';
	$nama = '';
	...
	?>
		<table>
			...
			<tr>
				...
				<td><img src="<?= base_url() ?>logo.png" alt="" style="height: 100px; width: 120px" /></td>
				<td>
	...
	<p align="center" class="visible-print-"><img src="<?= base_url() ?>/dist/img/copy.png" alt="" style="" /></p>
