<div class="table-responsive">
  ...
  $get_juduledisi=$this->Madmin_master->get_judul_edisi(1)->row();
  			?>
		 <a data-toggle="collapse" data-parent="#accordion1" href="#collapseOneb1">
	...
	<tr>
		<td colspan="2">
	<div id="collapseOneb1" class="panel-collapse collapse">
	 <table class="table no-margin">
                  <thead>
                  <tr bgcolor="#d9d9dd">
                    <th>No</th>
  ...
  if($get_juduledisi->num_rows() > 0){
  	...
  	$get_edisi='';
  			...
  			?>
	<tr>
		 <th><a data-toggle="collapse" data-parent="#accordion<?=$x?>" href="#collapseOnebb<?=$x?>">
         Ed. <?=$x.' '.$get_edisi?> 
	...
	<tr>
		<td colspan="2">
	<div id="collapseOnebb<?=$x?>" class="panel-collapse collapse">
	<table class="table no-margin">
                  <thead>
                  <tr bgcolor="#d9d9dd">
                    <th>No</th>
