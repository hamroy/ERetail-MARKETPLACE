 ...
 <section class="content">
   ...
   <?php
    ...
    $gpv = $this->M_vparsel->get_pesan_voc_parsel_id($id_user, $id_voc_s);
    ...
    if ($gpv->num_rows() == 0) {
      ...
      $dvoc = array(
        ...
        '0' => 'Untuk Mendapatkan Voucher PARSEL <br/>
    ...
    if ($get_setvocall->row()->vc4 == 0) { ///vc4 == parsel
   ...
   <?php
    ...
    $this->load->view('pages/admin/dompet_p/saldo_voucher');
     ...
     <div class="modal-dialog">
       ...
       <div class="modal-content">
         ...
         <div class="modal-body">
           ...
           <form class="form-horizontal" action="<?= base_url('C_dompetp/pesan_voucher_p/' . $id_user) ?>" method="post" enctype="multipart/form-data" id="theform2">
