   ...
   <?php
    ...
    if ($gpv->num_rows() == 0) {
      ...
      $dvoc = array(
        ...
        '0' => 'Untuk Mendapatkan Voucher <br/>
     ...
     <div class="modal-dialog">
       ...
       <div class="modal-content">
         ...
         <div class="modal-body">
           ...
           <form class="form-horizontal" action="<?= base_url('C_voc_acc/pe_terima_voucher_makan/' . $id_user . '/2') ?>" method="post" enctype="multipart/form-data" id="theform2">
