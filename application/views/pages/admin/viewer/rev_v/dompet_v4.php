 ...
 <section class="content">
   ...
   <?php
    ...
    echo '<br/>edisi=' . $no_edisi = $gt_tblinputpesanvoucher_select_tahap;   /// edisi 

    echo '<br/> th lanjut=' . $th2 = $th + 1; ///lanjut disi





    $gt_tblinputpesanvoucher = $this->Login_model->get_daftar_input_voucher($id_user, $th); //tbl pesan paucher

    $gt_tblinputpesanvoucher_awal = $this->Login_model->get_daftar_input_voucher_old($id_user, $th); //tbl pesan paucher

    $gt_tblinputpesanvoucher_b2 = $this->Login_model->get_daftar_input_voucher_bonus($id_user, 2); //tbl pesan paucher
    ...
    if ($gt_tblpesanvoucher->num_rows() > 0) {
      ...
      echo '<br/>pesan_voc =' . $s_aw0 = $gt_tblpesanvoucher->row()->pesan_voc;
         ...
         <div class="col-md-4">
           ...
           <?php
            ...
            if ($gt_tblinputpesanvoucher->num_rows() > 0) { //tbl input vocher sudah ada
              ...
              if ($gt_tblinputpesanvoucher->row()->status == 0) { // sudah meerima yanh terakhir
            ...
            ?>
             ...
             <?php
              ...
              } elseif ($gt_tblinputpesanvoucher->row()->status == 99) { ////buat setelah di tolak
              ...
              ?>
               ...
               <div class="callout callout-success">
                 ...
                 <h4>Untuk Mendapatkan Voucher Makan
                   ...
                   <a onclick="return confirm('Anda Yakin !')" href="<?= base_url('C_dompet/pesan_voucher_t2/' . $id_user . '/' . $th . '/' . $idisi) ?>">
         ...
         <div class="col-md-4">
           ...
           <div class="callout callout-warning">
             ...
             <?PHP
              ...
              if ($gt_tblinputpesanvoucher_b2->num_rows() > 0) {
           ...
           <div class="callout callout-warning">
             ...
             <?PHP
              ...
              if ($gt_tblinputpesanvoucher_b2->num_rows() > 0) {
                ...
                $urlh4j = base_url('C_dompet/pesan_voucher_t2_bonus/' . $id_user . '/' . $th . '/2');
