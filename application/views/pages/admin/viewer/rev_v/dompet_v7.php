         ...
         <form class="form-horizontal" action="<?= base_url('C_dompet_2/pesan_voucher/' . $id_user) ?>" method="post" enctype="multipart/form-data" id="theform2">
           ...
           <div class="box-body">
             ...
             <div class="form-group">
               ...
               <label for="inputEmail3" class="col-sm-3 control-label" style="color: #000000">NIK/NIP/NIM/Kode Sub Unit Kerja</label>



               <div class="col-sm-9">

                 <input type="text" class="form-control" value="" required="required" style="border-radius: 6px" name="nik" id="inputEmail3" placeholder="NIK/NIP/NIM/Kode Sub Unit Kerja">

                 <small class="text-danger">(*) NIK/NIP/NIM/Kode Sub Unit Kerja wajib diisi </small>
             ...
             <div class="form-group">
               ...
               <div class="col-sm-9">
                 ...
                 <input type="text" class="form-control" required="required" value="" required="required" style="border-radius: 6px" name="unit" id="inputEmail3" placeholder="Unit Kerja">
                 <small class="text-danger">(*) Unit Kerja wajib diisi </small>
               </div>
