 ...
 <section class="content">
   ...
   <?php
    ...
    // terdaftar tidanya
    //echo strlen($ni);
    //cek panjang karakter juga
    $cekmhsaktif = $this->M_adminvoc->cekniaktif($ni, 0);
     ...
     <div class="modal-dialog">
       ...
       <div class="modal-content">
         ...
         <div class="modal-body">
           ...
           <form class="form-horizontal" action="<?= base_url('C_voc_acc/pe_terima_voucher_makan/' . $id_user) ?>" method="post" enctype="multipart/form-data" id="theform2">
