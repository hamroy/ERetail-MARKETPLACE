            ...
            <div class="box-body">
              ...
              <div class="table-responsive">
                ...
                <table class="table no-margin">
                  ...
                  $get_all_id_produk=$this->Madmin->get_Produk_dipesan_perid_transaksi($this->session->userdata('id_user'),$id);
    ...
    <div class="modal-content">
      ...
      <!--C_transelesai-->
          ...
          <form class="form-horizontal" method="post" enctype="multipart/form-data" id="theform">
           ...
           <input type="hidden" id="exampleInputName2" name="jevoc" value="<?=$vjvoc?>" 
