...
////20180501 v parsel
$iduser = $id_user;
$id_voc_s = $this->M_voucher->get_max_id_voc();  ///e makan

$gpv = $this->M_vparsel->get_saldo_voc_makan_iduser($iduser, $id_voc_s, 1); ///get saldo awal || 1=prsoes acc
$gettotal_parsel = $this->M_vparsel->get_total_tbltransaksi_vmakan($iduser, $id_voc_s, 0); //tbltransaksi|| 0=makan
$gettotal_parsel_pesan = $this->M_vparsel->get_total_tbltransaksi_vmakan_pesan($iduser, $id_voc_s, 0); //tbltransaksi
...
///update sisa saldo
$gsvoc = $this->M_vparsel->get_sisa_voc($id_user, $id_voc_s, 0);     ///0=makan,
...
$gettotal_parsel_dapat = $this->M_vparsel->get_total_tbltransaksi_vmakan_didapat($iduser, $id_voc_s, 0); //tbltransaksi pendapatan per voucher

$get_reedeem = $this->Mbmt->get_tbl_reedeem_perid_user($id_user, 0); ///1=parsel , 0=makan ,2=song2
$get_reedeem_tp = $this->Mbmt->get_tbl_reedeem_perid_user_perstatus($id_user, 0, 0);
//$get_voch=$this->Madmin->get_all_transaksi_id_user_obatal_dibeli_voucher($id_user,1);
$redvocpar = 0;  //redeem par voc
$salpenvocpar = $gettotal_parsel_dapat - $get_reedeem; ///hasil akhir pendapatan
$dompet = $salpenvocpar;
$dompet_dicairkan = $get_reedeem_tp;
  ...
  <div class="col-xs-12 col-md-6">
    ...
    <div class="panel panel-primary">
      ...
      <div class="panel-body">
        ...
        <!-- <h4 align="center" ><b>Rp : <?= number_format($voucher_umy, 0, ',', '.') ?></b></h4>-->
                ...
                <div class="modal-body">
                  ...
                  <form class="form-horizontal" method="post" enctype="multipart/form-data" id="theform">
                    ...
                    <div class="box-body">
                      ...
                      <input type="hidden" name="jvoc" value="0" />
                    </div>
                    ...
                    <div class="box-footer">
                      ...
                      <input id="btnsubmit" value="Lanjut" onclick="return konfirmasiredeem('<?= base_url('C_dompetp/redeem_voucher_v2/' . $id_user . '/0') ?>')" type="submit" class="btn btn-success pull-right btn-block btn-lg" />
  ...
  <div class="col-xs-12 col-md-6">
    ...
    <div class="panel panel-warning">
      ...
      <div class="panel-body" style="height: 133px">
        ...
        <a href="<?= base_url('C_dompet/cetakan_beranda_riwayat') ?>" class="btn btn-info">Riwayat Redeem</a>
