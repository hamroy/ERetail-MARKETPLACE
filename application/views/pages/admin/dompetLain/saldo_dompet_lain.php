...
///GALLVOC 201811
$gv = $this->M_saldompet->gDomall($id_user);  ///
/////
$salpenvocpar = $gv['dompet_selesai']; ///hasil akhir pendapatan (cetak)
$get_reedeem_tp = $gv['redeem'];
?>


<div class="row" style="padding-bottom: 18%">
  ...
  <div class="col-xs-12 col-md-6">
    ...
    <div class="panel panel-success">
      ...
      <div class="panel-body">
        ...
        $cektgl = $this->M_time->get_tbl_ttgl($pectgl[0]); //0k
                ...
                <div class="modal-body">
                  ...
                  <form class="form-horizontal" method="post" enctype="multipart/form-data" id="theform">
                    ...
                    <div class="box-body">
                      ...
                      <input type="hidden" name="jvoc" value="99" />
                    </div>
                    ...
                    <div class="box-footer">
                      ...
                      <input id="btnsubmit" value="Lanjut" onclick="return konfirmasiredeem('<?= base_url('C_dompetp/redeem_voucher_v2/' . $id_user . '/99') ?>')" type="submit" class="btn btn-success pull-right btn-block btn-lg" />
  ...
  <div class="col-xs-12 col-md-6">
    ...
    <div class="panel panel-warning">
      ...
      <div class="panel-body" style="height: 133px">
        ...
        <a href="<?= base_url('C_dompet/cetakan_beranda_riwayat/99') ?>" class="btn btn-info">Riwayat Redeem</a>
