...
?>
  ...
  <div class="col-xs-12 col-md-6 pull-right" >
   <form action="<?=base_url('Master_admin/list_penjual/cari/'.$ak)?>" method="post">
    <div class="input-group" >
      <input type="text" name="cari" placeholder="Nama Akun / NIM / NBM..." class="form-control" list="bawahnama" required>
  ...
  <!-- rev201902 -->
            ...
            <h3 class="well well-md">
              ...
              <div class="input-group" style="width: 50%">
                <span class="input-group-addon" id="basic-addon2">Prodi</span>
                <select name="sortprodi" class="form-control"  onchange="loadPage(this.form.elements[0])">
                      ...
                      foreach($gjob->result() as $jb){
                        $slpro='';
                         ...
                         $gtprodi=$this->Mmahasiswa->get_akunprodi($jb->kode_nim);
                          ?>

                           <option value="<?=base_url('Master_admin/sortprodi_pelapakakunmhs/'.$jb->kode_nim)?>" <?=$slpro?>> <?=$jb->kode_nim?> - <?=$jb->nama_prodi?> [ <?=$gtprodi->num_rows()?> ]</option>
                ...
                <option value="<?=base_url('Master_admin/sortprodi_pelapakakunmhs/0')?>"> 0 - Prodi kosong 
                  [ <?=$this->Mmahasiswa->get_akunprodi(0)->num_rows()?> ]</option>
              ...
              <div class="col-md-2">
              <a href="<?=base_url('C_cetak/cetak_akunP/xls/'.$ak)?>" class="btn btn-primary  pull-right">XLS</a>
              </div>
