<div class="row">
  ...
  $gettotal_parsel = $this->M_vparsel->get_total_tbltransaksi_vparsel($iduser, $id_voc_s, 2);  //tbltransaksi
  $gettotal_parsel_pesan = $this->M_vparsel->get_total_tbltransaksi_vparsel_pesan($iduser, $id_voc_s, 2);  //tbltransaksi
  $gettotal_parsel_dapat = $this->M_vparsel->get_total_tbltransaksi_vparsel_didapat($iduser, $id_voc_s, 2);  //tbltransaksi
  ...
  ///update sisa saldo
  $gsvoc = $this->M_vparsel->get_sisa_voc($id_user, $id_voc_s, 1);     ///0=makan,1=song2,2=parsel
  ...
  $get_reedeem_tp = $this->Mbmt->get_tbl_reedeem_perid_user_perstatus($id_user, 2, 0);
  //$get_voch=$this->Madmin->get_all_transaksi_id_user_obatal_dibeli_voucher($id_user,1);
  $redvocpar = 0;  //redeem par voc

  $salpenvocpar = $gettotal_parsel_dapat - $get_reedeem; ///saldo pendapatan = transaksi-redeem(selain tolak)
                  ...
                  <form class="form-horizontal" method="post" enctype="multipart/form-data" id="theform">
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="hidden" name="jvoc" value="2" />
                    ...
                    <div class="box-footer">
                      ...
                      <input id="btnsubmit" value="Lanjut" onclick="return konfirmasiredeem('<?= base_url('C_dompetp/redeem_voucher_v2/' . $id_user . '/2') ?>')" type="submit" class="btn btn-success pull-right btn-block btn-lg" />
  ...
  <div class="col-xs-12 col-md-6">
    ...
    <div class="panel panel-warning">
      ...
      <div class="panel-body" style="height: 133px">
        ...
        <a href="<?= base_url('C_dompet/cetakan_beranda_riwayat/2') ?>" class="btn btn-info">Riwayat Redeem</a>
