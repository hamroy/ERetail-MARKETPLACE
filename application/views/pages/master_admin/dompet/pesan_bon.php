  ...
  if($get_juduledisi->num_rows() > 0){
  	...
  	$get_edisi='';
  			...
  			?>
	<tr>
		 <th><a data-toggle="collapse" data-parent="#accordion<?=$x?>" href="#collapseOnebon<?=$x?>">
          <?=$x.'. '.$get_edisi?> 
       ...
       $get_all_id_produk=$this->Madmin_master->get_pemesan_vo_2_id_edisi_bon('0',$x);
	...
	<tr>
		<td colspan="2">
	<div id="collapseOnebon<?=$x?>" class="panel-collapse collapse in">
	<table class="table no-margin">
                  <thead>
                  <tr bgcolor="#d9d9dd">
                    <th>No</th>
...
<div class="modal fade" id="myModaltblsfeok<?=$gidp->id?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form role="form" action="<?=base_url('C_dompet/terima_pesan_voc_2/bon/t/'.$gidp->id_user.'/'.$gidp->id.'/')?>" method="post">
...
<div class="modal fade" id="myModaltblsfe<?=$gidp->id?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form role="form" action="<?=base_url('C_dompet/terima_pesan_voc_2/bon/b/'.$gidp->id_user.'/'.$gidp->id)?>" method="post">
  <div class="form-group">
