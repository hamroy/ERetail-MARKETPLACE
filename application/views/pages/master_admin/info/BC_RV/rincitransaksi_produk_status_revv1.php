...
//===========================================GRUP STATUS PEKERJAAN================================================
                ...
                foreach($get_id_produk->result() as $gidp){
                   ...
                   $get_id_produk_rinci=$this->Madmin_master->get_transaksi_sort_job_harga_rinci($bln,$thn,$jb->id_job,$gidp->id_user); 
                    ...
                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree<?=$gidp->id_pembeli?>" aria-expanded="false" aria-controls="collapseThree">
                     Lihat Rinci
                    </a>
                    </span>
                    </td>
                    ...
                    ?>
                     <tr>
                      ...
                      <tr>
                      <td colspan="10">
                     <div id="collapseThree<?=$gidp->id_pembeli?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
...
///=============================================================================================================================================================================================================================================================================================================================================================================================================================================================				  
                ...
                foreach($get_id_produk2->result() as $gidp){
                   ...
                   $get_id_produk_rinci=$this->Madmin_master->get_transaksi_nosort_job_sr1_rinci($bln,$thn,$gidp->id_pembeli); 
                   }
                    ////////REVrinci grupidpembeli
					$getuser=$this->Madmin_master->get_user_produk($gidp->id_user);	
