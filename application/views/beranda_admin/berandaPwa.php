...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="wrapper">
      ...
      <nav class="navbar navbar-fixed-top" role="navigation" style="background: #2d5726; ">
        ...
        <div class="navbar-custom-menu">
          ...
          <ul class="nav navbar-nav">
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      ...
                      foreach ($list->result() as $kj) {
                        ...
                        $string = read_file($this->M_setapp->static_bm() . '/upload/' . $barang->row()->gambar);
            ...
            $string = read_file($this->M_setapp->static_bm() . '/upload/profil/' . $img);
          ...
          <?php
            ...
            <li class="<?= $m ?>">
              ...
              <?php
                                                                                                                          ...
                                                                                                                          $id_vocall = $this->M_vparsel->get_max_id_vocall(4); ///menuju edisi MHS
                                                                                                                          $all_newvoucer213 = $this->M_vparsel->get_pemesan_voc_makan_all($id_voc_s);     //makan
                                                                                                                          $all_newvoucer211 = $this->M_vparsel->get_pemesan_voc_song_all($id_voc_song);    //songsog
                                                                                                                          $all_newvoucer222 = $this->M_vparsel->get_pemesan_voc_parsel_all($id_voc_par);     //parsel
                                                                                                                          $all_newmhs_job = $this->M_vparsel->get_Pesan_voucher_mhs(3, $id_voc_mhs);     // MAHASISWA UNIT MHSISWA SAJA
                                                                                                                          $all_newpesvoc = $this->M_voucher->get_pesan_voc_all_iduser_beranda($id_vocall, 4, 0);     // MAHASISWA UNIT MHSISWA SAJA
                                                                                                                          $notvar[0] = $all_newvoucer213->num_rows();
                                                                                                                          $notvar[1] = $all_newvoucer211->num_rows();
                                                                                                                          $notvar[2] = $all_newvoucer222->num_rows();
                                                                                                                          $notvar[3] = $all_newmhs_job->num_rows();
                                                                                                                          $notvar[4] = $all_newpesvoc->num_rows();

                                                                                                                          $vpcer = $notvar[0] + $notvar[1] + $notvar[2] + $notvar[3] + $notvar[4];

                                                                                                                          if ($vpcer > 0) {

                                                                                                                            $vcnew = ' <span class="pull-right-container"><span class="label label-primary pull-right">' . $vpcer . '</span></span>';
                                                                                                                          } else {
            ...
            <?php
                                                                                                                          ...
                                                                                                                          $C_t = isset($C_t) ? $C_t : '';
            ?>
            <li class="<?= $C_t ?>"><a href="<?= base_url('C_transfer/') ?>"><i class="fa  fa-shield"></i><span>Kendali Transfer </span>
              </a></li>


            <li class="<?= $v1 ?>" class="treeview">

              <a href="<?= base_url('Master_admin') ?>">

                <i class="fa fa-share"></i> <span>Pengguna Voucher</span>
              ...
              <ul class="treeview-menu">
                <?php
                                                                                                                          $v1_a = !empty($v1_a) ? $v1_a : '';
                                                                                                                          $v1_b = !empty($v1_b) ? $v1_b : '';
                ?>

                <li class="<?= $v1_a ?>"><a href="<?= base_url('Master_admin/list_penerima_voucher/') ?>"><i class="fa fa-list"></i><span>Penerima Voucher</span></a></li>

                <li class="<?= $v1_b ?>"><a href="<?= base_url('Master_admin/list_penerima_voucher_tolak/') ?>"><i class="fa fa-list"></i><span>Daftar Ditolak</span></a></li>

                <!-- <li class=""><a href="<?= base_url('Master_admin/daftar_Saldo_voucer') ?>"><i class="fa fa-list"></i><span>Daftar saldo voucher</span></a></li>-->

                <li class=""><a href="<?= base_url('C_dompet/sett_voc_all') ?>"><i class="fa fa-wrench"></i><span>Pengaturan Voucher</span></a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li class=""><a href="<?= base_url('C_dompet_2/riwayat_edisi_voc_2') ?>"><i class="fa fa-list"></i><span>Riwayat Edisi Voucher 2</span></a></li>
    ...
    <footer class="main-footer" style="margin-bottom: 1px ">
      ...
      <strong>Copyright &copy; 2017 - <?= date('Y') ?> || <a href="#" target="_blank">E-Retail SUPERMALL</a></strong>
